...
export class AnnouncementCard {
  ...
  announcements: {title: string; description: string; author: string; date: string; isPinned: boolean}[] = [
     {
...
pinClicked(announcement: any) {
  announcement.isPinned = !announcement.isPinned;
  console.log(`${announcement.title} pinned status:`, announcement.isPinned);
...
deleteAnnouncement(title: string) {
  this.announcements = this.announcements.filter(a => a.title !== title);
  console.log('Deleted announcement:', title);
}
